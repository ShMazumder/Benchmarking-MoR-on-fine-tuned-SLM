...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{figures/routing_mechanism.png}
...
Both models are fine-tuned as language models on the Tiny Shakespeare excerpt dataset. The fine-tuning pipeline followed these configurations in Table \ref{tab:training_config}.

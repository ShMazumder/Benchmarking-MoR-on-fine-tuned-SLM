...
\title{Benchmarking Mixture-of-Recursion (MoR) on Small Language Models}
...
\begin{IEEEkeywords}
Mixture-of-Recursion (MoR), LLM, SLM, Transformer, Recursive wise KV cache, Routing Mechanism (Adapted from \cite{b11}).
\end{IEEEkeywords}

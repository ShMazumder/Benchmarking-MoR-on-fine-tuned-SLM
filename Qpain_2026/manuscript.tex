...
\begin{itemize}
    ...
    \item \textbf{WikiText-2:} A standard benchmark for word/subword modeling ($\sim$2M tokens). It offers a realistic vocabulary and is used to test the model on higher information densitiy.
...
\begin{enumerate}
    ...
    \item \textbf{Word-level (WikiText-2):} High semantic density. Whitespace/Punctuation splitting. Vocab: $\sim$33,000.
\end{enumerate}

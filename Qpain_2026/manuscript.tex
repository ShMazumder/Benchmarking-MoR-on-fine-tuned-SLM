...
\title{Benchmarking Mixture-of-Recursion (MoR) across Character and Subword-Level Language Modeling}
...
\begin{enumerate}
    \item \textbf{Character-level (Shakespeare):} Granular but sparse. Vocab: 55.

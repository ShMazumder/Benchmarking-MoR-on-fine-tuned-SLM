#!/usr/bin/env python3
"""
Generate the FINAL fixed notebook - with correct shell command syntax
"""
import json
...
with open("run_bangla_FINAL_FIX.ipynb", 'w') as f:
    json.dump(notebook, f, indent=2)

print("✓ Fixed notebook generated")
print("  - Removed escaped backslashes")
print("  - Simplified corpus download (Wikipedia only)")
print("  - Streamlined all cells")
